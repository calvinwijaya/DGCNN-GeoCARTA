...
def room2blocks_plus_normalized(data_label, num_point, block_size, stride,
    ...
    data[:, 6] /= np.max(data[:, 6]) # normalized intensity
    ...
    # Add Intensity
    new_data_batch = np.zeros((data_batch.shape[0], num_point, 10)) # XYZ, RGB, I, normXYZ
    ...
    for b in range(data_batch.shape[0]):
        ...
        # Add Intensity
        new_data_batch[b, :, 7] = data_batch[b, :, 0] / max_room_x
        new_data_batch[b, :, 8] = data_batch[b, :, 1] / max_room_y
        new_data_batch[b, :, 9] = data_batch[b, :, 2] / max_room_z
    ...
    # Add Intensity
    new_data_batch[:, :, 0:7] = data_batch[:,:,0:7] # for XYZ, RGB, I
